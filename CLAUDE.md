...
**YOU ARE IN: `bitcoin/polecats/quartz/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/bitcoin/` (rig root) or other directories
...
**Your mail address:** `bitcoin/polecats/quartz`
**Your rig:** bitcoin
**Your Witness:** `bitcoin/witness`
...
| Ask Witness for help | `gt mail send bitcoin/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`bitcoin/witness`) when:
...
```bash
gt mail send bitcoin/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
