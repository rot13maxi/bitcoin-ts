 ...
 */
export function serializeUint8Array(stream: Stream, data: Uint8Array | readonly number[]): void {
    stream.write(data);
}
 ...
 */
export function unserializeUint8Array(stream: Stream, size: number): Uint8Array {
