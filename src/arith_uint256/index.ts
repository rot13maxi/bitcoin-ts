...
export class arith_uint256 extends BaseUint {
  ...
  setCompact(
    nCompact: number,
    options?: { negative?: boolean; overflow?: boolean },
  ): arith_uint256 {
...
export function uintBitwiseAnd(
  a: arith_uint256,
  b: arith_uint256,
): arith_uint256 {
  const result = a.clone();
...
export function uintBitwiseXor(
  a: arith_uint256,
  b: arith_uint256,
): arith_uint256 {
  const result = a.clone();
...
export function uintLessThanOrEqual(
  a: arith_uint256,
  b: arith_uint256,
): boolean {
  return a.compareTo(b) <= 0;
...
export function uintGreaterThanOrEqual(
  a: arith_uint256,
  b: arith_uint256,
): boolean {
  return a.compareTo(b) >= 0;
