...
function test_bech32() {
  ...
  console.log(
    "  Decode encoding:",
    decoded2.encoding === Encoding.BECH32 ? "BECH32" : "other",
  );
...
function test_base58() {
  ...
  console.log(
    "  Empty decode:",
    emptyDecoded !== null && emptyDecoded.length === 0,
  );
...
function test_key_io() {
  ...
  console.log(
    "  Decoded P2WPKH is WitnessPKHash:",
    decodedWpkh instanceof WitnessPKHash,
  );
